...
hello.utils = {
        ...
        login: function() {
            ...
            var u = i.services[s.network],
                c = a.globalEvent(function(e) {
                    var n;
                    n = e ? JSON.parse(e) : t("cancelled", "The authentication was not completed"), n.error ? r.reject(n) : (a.store(n.network, n), r.fulfill({
                        network: n.network,
                        authResponse: n
                    }))
                }),
                d = a.url(l.redirect_uri).href,
                f = u.oauth.response_type || l.response_type;
            /\bcode\b/.test(f) && !u.oauth.grant && (f = f.replace(/\bcode\b/, "token")), s.qs = {
                client_id: encodeURIComponent(u.id),
                response_type: encodeURIComponent(f),
            ...
            if (m = (m ? m + "," : "") + s.qs.scope, p && "scope" in p && p.scope instanceof String && (m += "," + p.scope), s.qs.state.scope = a.unique(m.split(/[,\s]+/)).join(","), s.qs.scope = m.replace(/[^,\s]+/gi, function(e) {
                ...
                if (0 === h.length) return r.fulfill({
                    unchanged: !0,
                    network: s.network,
                    authResponse: p
                }), r
            }
            if ("page" === l.display && l.page_uri && (s.qs.state.page_uri = a.url(l.page_uri).href), "login" in u && "function" == typeof u.login && u.login(s), (!/\btoken\b/.test(f) || parseInt(u.oauth.version, 10) < 2 || "none" === l.display && u.oauth.grant && p && p.refresh_token) && (s.qs.state.oauth = u.oauth, s.qs.state.oauth_proxy = l.oauth_proxy), s.qs.state = encodeURIComponent(JSON.stringify(s.qs.state)), 1 === parseInt(u.oauth.version, 10) ? o = a.qs(l.oauth_proxy, s.qs, n) : "none" === l.display && u.oauth.grant && p && p.refresh_token ? (s.qs.refresh_token = p.refresh_token, o = a.qs(l.oauth_proxy, s.qs, n)) : o = a.qs(u.oauth.auth, s.qs, n), "none" === l.display) a.iframe(o);
            else if ("popup" === l.display) var g = a.popup(o, d, l.window_width || 500, l.window_height || 550),
        ...
        logout: function() {
            ...
            if (a.options = a.options || {}, i.proxy.then(a.callback, a.callback), i.proxy.then(e.bind(this, "auth.logout auth"), e.bind(this, "error")), a.name = a.name || this.settings.default_service, !a.name || a.name in n.services)
                if (a.name && o.store(a.name)) {
                    var r = function(e) {
                            o.store(a.name, ""), i.fulfill(hello.utils.merge({
                                network: a.name
                            }, e || {}))
                        },
                        s = {};
                    if (a.options.force) {
                        ...
                        if (l)
                            if ("function" == typeof l && (l = l(r)), "string" == typeof l) o.iframe(l), s.force = null, s.message = "Logout success on providers site was indeterminate";
        ...
        param: function(e, t) {
            ...
            if ("string" == typeof e) {
                if (t = t || decodeURIComponent, o = e.replace(/^[\#\?]/, "").match(/([^=\/\&]+)=([^\&]+)/g))
                    for (var a = 0; a < o.length; a++) n = o[a].match(/([^=]+)=(.*)/), i[n[1]] = t(n[2]);
                return i
            }
    ...
    function(e) {
                ...
                for (var r in e.services)
                    if (e.services.hasOwnProperty(r)) {
                        ...
                        if (s && "expires" in s && s.expires < i) {
                            ...
                            !f || r in n && !(n[r] < i) ? f || r in n || (a("expired"), n[r] = !0) : (e.emit("notice", r + " has expired trying to resignin"), e.login(r, {
                                display: "none",
                                force: !1
                            }), n[r] = i + 600);
                            continue
        ...
        function e(e) {
            e = e.replace(/\@\{([a-z\_\-]+)(\|.+?)?\}/gi, function(e, n, o) {
                ...
                if (e === !0 ? e = {
                        success: !0
                    } : e || (e = {}), "delete" === a.method && (e = !e || o.isEmpty(e) ? {
                        success: !0
                    } : e), u.wrap && (a.path in u.wrap || "default" in u.wrap)) {
                    var n = a.path in u.wrap ? a.path : "default",
                        r = ((new Date).getTime(), u.wrap[n](e, t, a));
                    r && (e = r)
                }
        ...
        xhr: function(e, t, n, o, i) {
            ...
            var r = new XMLHttpRequest,
                s = !1;
            "blob" === e && (s = e, e = "GET"), e = e.toUpperCase(), r.onload = function(t) {
                var n = r.response;
                try {
                ...
                var s = a(r.getAllResponseHeaders());
                s.statusCode = r.status, i(n || ("GET" === e ? {
                    error: {
                        code: "empty_response",
            ...
            if (r.open(e, t, !0), s && ("responseType" in r ? r.responseType = s : r.overrideMimeType("text/plain; charset=x-user-defined")), n)
        ...
        jsonp: function(e, t, n, o) {
            ...
            n = r.globalEvent(function(e) {
                return u = e, !0
            }, n), e = e.replace(new RegExp("=\\?(&|$)"), "=" + n + "$1"), a = r.append("script", {
                id: n,
                name: n,
                src: e,
                async: !0,
            ...
            if (s.domInstance("form", t))
                ...
                for (f in t)
                    if (t.hasOwnProperty(f)) {
                        ...
                        if (y && t[f].form === u) y && t[f].name !== f && (t[f].setAttribute("name", f), t[f].name = f);
                        else {
                            var w = u.elements[f];
                            if (v)
                                for (w instanceof NodeList || (w = [w]), d = 0; d < w.length; d++) w[d].parentNode.removeChild(w[d]);
    ...
    }), hello.subscribe = hello.on, hello.trigger = hello.emit, hello.unsubscribe = hello.off,
    function(e) {
        function t(e) {
    ...
    function(e) {
        ...
        function o(e, t, n) {
            if ("boolean" == typeof e && (e = {
                ...
                for (var o = n.query.access_token, a = 0; a < e.data.length; a++) {
                    var r = e.data[a];
        ...
        e.init({
            facebook: {
                name: "Facebook",
                login: function(e) {
                    e.options.auth_type && (e.qs.auth_type = e.options.auth_type), e.options.window_width = 580, e.options.window_height = 400
                },
                oauth: {
                    version: 2,
    ...
    function(e) {
        ...
        function o(e) {
            r(e);
            var t = function(e) {
                    var t, n = e.media$group.media$content.length ? e.media$group.media$content[0] : {},
                        o = 0,
                        i = {
                            id: e.id.$t,
                            name: e.title.$t,
    ...
    function(e) {
        ...
        function n(e, n, o) {
            if ("data" in e)
                for (var i = 0; i < e.data.length; i++) t(e.data[i], n, o);
            return e
        }
        e.init({
            windows: {
